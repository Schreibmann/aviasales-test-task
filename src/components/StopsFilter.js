        ...
        let filterItems = this.props.initialStops.map((e, i, a) => {
            const stopsLabel =
                e > 1
                    ...
                    : e === 1
                        ? "1 Пересадка"
                        : "Без пересадок"; // format stops label
            const cheapestPrice = ticketData.filter(
                ticket => ticket.stops === e
            )[0].price; // get cheapest price for each stops count
                            ...
                            >
                                <span className="checkbox">
                                    <input
                                        ...
                                        id="stops_all"
                                        onChange={event =>
                                            this.props.toggleSelectAll(event)
                                        }
                                        checked={
                                            this.props.filterItemsAllChecked
                                        }
                                    />

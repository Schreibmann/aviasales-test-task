...
class TicketData extends React.Component {
	...
	render() {
		const stopsLabel =
			this.props.ticketData.stops > 1
				? this.props.ticketData.stops + " ПЕРЕСАДКИ"
				: this.props.ticketData.stops === 1
					? "1 ПЕРЕСАДКА"
					: "";
							...
							<div className="ticket__segment segment">
								<div className="segment-route">
									...
									<div className="segment-route__path">
										<div className="segment-route__total-stops">
											{stopsLabel}
										</div>
									...
									<div className="segment-route__destination">
										<div className="segment-route__time">
											{this.props.ticketData.arrival_time}
										</div>
										<div className="segment-route__city">
											{`${
												this.props.ticketData
